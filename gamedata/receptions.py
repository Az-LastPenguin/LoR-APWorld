...
reception_nodes: list[ReceptionNode] = [
    ...
    ReceptionNode(id=20002, name="Zwei Association I", checks=5, next=[20003], chapter = 3),
    ReceptionNode(id=20003, name="Zwei Association II", checks=5, next=[20004, 20005, 30002, 30003, 100009, 100010, 100014], chapter = 3),
    ReceptionNode(id=20004, name="Molar Office", checks=6, next=[30004, 100009, 100010, 100014], chapter = 3),
    ReceptionNode(id=20005, name="Stray Dogs", checks=6, next=[30001, 100009, 100010, 100014], chapter = 3),

    ReceptionNode(id=100004, name="Grade 8 Fixers", checks=4, next=[], chapter = 3),
    ReceptionNode(id=100005, name="Grade 7 Fixers", checks=4, next=[], chapter = 3),
    ReceptionNode(id=100006, name="Urban Legend-class Office", checks=4, next=[], chapter = 3),
    ReceptionNode(id=100007, name="Urban Legend-class Syndicate", checks=4, next=[], chapter = 3),
    ReceptionNode(id=100008, name="Axe Gang", checks=4, next=[], chapter = 3),

    # Urban Plague
    ReceptionNode(id=30001, name="The Carnival", checks=5, next=[30006], chapter = 4),
    ...
    ReceptionNode(id=100014, name="Jeong's Office", checks=5, next=[], chapter = 4),
    ...
    ReceptionNode(id=40008, name="The Crying Children", checks=8, next=[50001, 100013, 100015, 100016, 100017, 100018, 100019], chapter = 5, req_librarians=3),

    ReceptionNode(id=100011, name="Seven Association", checks=5, next=[], chapter = 5, req_librarians=2),
    ReceptionNode(id=100012, name="Blade Lineage", checks=5, next=[], chapter = 5, req_librarians=2),

    # Star of the City
    ReceptionNode(id=50001, name="Liu Association Section 2", checks=5, next=[50002], chapter = 6, req_librarians=3),
    ReceptionNode(id=50002, name="Liu Association Section 2 II", checks=5, next=[50008], chapter = 6, req_librarians=3),
    ReceptionNode(id=50003, name="The Thumb", checks=5, next=[50004], chapter = 6, req_librarians=3),
    ReceptionNode(id=50004, name="The Thumb II", checks=5, next=[50007], chapter = 6, req_librarians=3),
    ReceptionNode(id=50005, name="Cane Office", checks=5, next=[50010], chapter = 6, req_librarians=3),
    ReceptionNode(id=50006, name="The Blue Reverberation", checks=5, next=[50009], chapter = 6, req_librarians=3),
    ReceptionNode(id=50007, name="Index Proxies", checks=6, next=[50014], chapter = 6, req_librarians=3),
    ReceptionNode(id=50008, name="Liu Association Section 1", checks=6, next=[50013], chapter = 6, req_librarians=3),
    ReceptionNode(id=50009, name="The Red Mist", checks=8, next=[50012], chapter = 6, req_librarians=4),
    ReceptionNode(id=50010, name="R Corp.", checks=6, next=[50011], chapter = 6, req_librarians=3),
    ReceptionNode(id=50011, name="R Corp. II", checks=6, next=[60001], chapter = 6, req_librarians=3),
    ReceptionNode(id=50012, name="The Purple Tear", checks=8, next=[60001], chapter = 6, req_librarians=4),
    ReceptionNode(id=50013, name="Xiao", checks=9, next=[60001], chapter = 6, req_librarians=4),
    ReceptionNode(id=50014, name="Distorted Yan", checks=9, next=[60001], chapter = 6, req_librarians=4),

    ReceptionNode(id=100013, name="Dong-hwan the Grade 1 Fixer", checks=5, next=[], chapter = 6, req_librarians=3),
    ReceptionNode(id=100015, name="Night Awls", checks=5, next=[], chapter = 6, req_librarians=3),
    ReceptionNode(id=100016, name="The Udjat", checks=5, next=[], chapter = 6, req_librarians=3),
    ReceptionNode(id=100017, name="Mirae Life Insurance", checks=5, next=[], chapter = 6, req_librarians=3),
    ReceptionNode(id=100018, name="Leaflet Workshop", checks=5, next=[], chapter = 6, req_librarians=3),
    ReceptionNode(id=100019, name="Bayard", checks=5, next=[], chapter = 6, req_librarians=3),
    
    # Impurity
    ReceptionNode(id=60001, name="Hana Association", checks=6, next=[60002], chapter = 7, req_librarians=3),
    ReceptionNode(id=60002, name="Oliver", checks=6, next=[], chapter = 7),
]
