...
reception_nodes: list[ReceptionNode] = [
    ...
    # Urban Nightmare
    ReceptionNode(id=40001, name="Shi Association", checks=5, next=[40007], chapter = 5),
    ReceptionNode(id=40002, name="Puppets", checks=5, next=[40006], chapter = 5),
    ReceptionNode(id=40003, name="The 8 o'Clock Circus", checks=5, next=[40008], chapter = 5),
    ReceptionNode(id=40004, name="Sweepers", checks=5, next=[40005], chapter = 5),
    ReceptionNode(id=40005, name="Index Proselytes", checks=6, next=[50003, 100013, 100015, 100016, 100017, 100018, 100019], chapter = 5),
    ReceptionNode(id=40006, name="WARP Cleanup Crew", checks=6, next=[50005, 100013, 100015, 100016, 100017, 100018, 100019], chapter = 5),
    ReceptionNode(id=40007, name="Smiling Faces", checks=6, next=[50006, 100013, 100015, 100016, 100017, 100018, 100019], chapter = 5),
    ReceptionNode(id=40008, name="The Crying Children", checks=8, next=[50001, 100013, 100015, 100016, 100017, 100018, 100019], req_librarians=2, chapter = 5),

    ReceptionNode(id=100011, name="Seven Association", checks=5, next=[], chapter = 5),
    ReceptionNode(id=100012, name="Blade Lineage", checks=5, next=[], chapter = 5),

    # Star of the City
    ReceptionNode(id=50001, name="Liu Association Section 2", checks=5, next=[50002], chapter = 6),
    ReceptionNode(id=50002, name="Liu Association Section 2 II", checks=5, next=[50008], chapter = 6),
    ReceptionNode(id=50003, name="The Thumb", checks=5, next=[50004], chapter = 6),
    ReceptionNode(id=50004, name="The Thumb II", checks=5, next=[50007], chapter = 6),
    ReceptionNode(id=50005, name="Cane Office", checks=5, next=[50010], chapter = 6),
    ReceptionNode(id=50006, name="The Blue Reverberation", checks=5, next=[50009], chapter = 6),
    ReceptionNode(id=50007, name="Index Proxies", checks=6, next=[50014], chapter = 6),
    ReceptionNode(id=50008, name="Liu Association Section 1", checks=6, next=[50013], chapter = 6),
    ReceptionNode(id=50009, name="The Red Mist", checks=8, next=[50012], chapter = 6),
    ReceptionNode(id=50010, name="R Corp.", checks=6, next=[50011], chapter = 6),
    ...
    ReceptionNode(id=100016, name="The Udjat", checks=5, next=[], chapter = 6),
    ReceptionNode(id=100017, name="Mirae Life Insurance", checks=5, next=[], chapter = 6),
    ReceptionNode(id=100018, name="Leaflet Workshop", checks=5, next=[], chapter = 6),
    ReceptionNode(id=100019, name="Bayard", checks=5, next=[], chapter = 6),
    
    # Impurity
    ReceptionNode(id=60001, name="Hana Association", checks=6, next=[60002], chapter = 7),
